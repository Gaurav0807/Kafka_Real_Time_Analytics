...
def process_streaming_data(spark, kafka_bootstrap_servers, kafka_topic):
    ...
    # Perform your Spark Streaming operations here
    # For example, you can write the data to console or another sink
    # query = (
    ...
    #     crypto_data_df.writeStream.outputMode("append")
    #     .format("json")
    #     .option("checkpointLocation","/Users/Desktop/Open_Source/Kafka/src/real_time_api/checkpoint")
    #     .start("/Users/Desktop/Open_Source/Kafka/src/real_time_api/output")
    # )
